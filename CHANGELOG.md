...
- Added public compatibility notes for hardware coverage, Profile 0 setup, macOS native controller profile positioning, and game-specific behavior such as Cult of the Lamb input glyph switching.
